    ...
    <div class="col-md-6">
      ...
      <div class="card shadow-lg">
        ...
        <div class="card-body">
          ...
          <a class="btn btn-info btn-sm mt-2 mb-4" href="<?php echo route_to('categories.archived'); ?>"><?php echo lang('App.btn_all_archive');?></a>
    ...
    <div class="modal-content">
      ...
      <?php echo form_open(route_to('categories.create'), ['id' => 'categories-form'], ['id' => '']); ?>
        ...
        <div class="modal-footer">
          <button id="btnCancel" type="button" class="btn btn-secondary btn-sm" data-bs-dismiss="modal"><?php echo lang('App.btn_cancel');?></button>
